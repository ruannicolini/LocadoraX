<%-- 
    Document   : ConsultaClasse
    Created on : 20/05/2015, 21:21:54
    Author     : Ruan
--%>
                    ...
                    <div class="col-sm-12" style="padding : 0"> 
                        <div class="row">
                            <div class="col-sm-3" style="padding :0">
                                <h1 class="page-title">Consultar Classe</h1>
                            </div>
                    ...
                    <div class="row" style="margin-right: 18px">
                        <table class="table table-responsive table-striped table-hover table-users">
                            ...
                            <tbody>
                                ...
                                function consultaCl(id)
                                {
                                    location.href= "EditarClasse.jsp?valor="+id;
                                }
                                </script>

                                <%
                                    Iterator<Classe> i = classes.iterator();
                                    while (i.hasNext()){            
                                        Classe cla = (Classe)i.next();
                                            out.println("<form action= \"ControllerClasse\" method=\"POST\">"
                                               +" <input type=\"hidden\" name=\"operacao\" value=\"excluir\">");
                                        
                                                                               
                                            out.println("<tr>");
                                            out.println("<td class= \"hidden-phone\">" + cla.getIdClasse()+ "</td>"
                                                + "<td>" + cla.getNome() + "</td>"
                                                + "<td>" + cla.getPrazo() + "</td>"
                                                + "<td>" + cla.getValor() + "</td>");

                                            out.println("<td>"
                                                            + "<button type=\"button\" onClick= \"consultaCl(" + cla.getIdClasse() + ")\">Editar</button>"
                                                    + "</td>"       
                                                    + "<td>"
                                                        + "<button type=\"submit\" name = \"btnExcluir\" value = "+ cla.getIdClasse() +">Excluir</button>"
                                                    + "</td>"                                           
                                            + "</tr>");
                                            out.println("</form>");
                                    }
