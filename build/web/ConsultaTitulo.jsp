<%-- 
    Document   : ConsultaTituloo
    Created on : 21/05/2015, 21:04:40
    Author     : Ruan
--%>
                                ...
                                <%
                                    ...
                                    while (i.hasNext()){            
                                        Titulo titul = (Titulo)i.next();
                                            ...
                                            out.println("<td>"
                                                            + "<button type=\"button\" onClick= \"consultaTitulo(" + titul.getIdTitulo() + ")\">Editar</button>"
                                                    + "</td>"       
                                                    + "<td>"
                                                        + "<button type=\"submit\" name = \"btnExcluir\" value = "+ titul.getIdTitulo() +">Excluir</button>"
                                                    + "</td>"                                           
                                            + "</tr>");
                                            out.println("</form>");
                                    }
