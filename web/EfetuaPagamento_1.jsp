                                                ...
                                                <div class="col-sm-6">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-11" style="padding :0">
                                                            ...
                                                            <input type="text" class="form-control" name="dtLocacao">
                                                            ...
                                                            <button type ="button" class="btn glyphicon glyphicon-search" onClick= 'myFunction()'> </button>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-12" style="padding :0">
                                                            ...
                                                            <button type ="button" class="btn glyphicon glyphicon-plus" onclick="location. href= 'ConsultaTitulo.jsp' "> </button>
                                                        </div> 
                                                    </div>
